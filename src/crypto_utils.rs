...
// pub fn sha256_joined(data: &[&[u8]]) -> [u8; SHA256_SIZE] {
//     let mut buf = Vec::new();
//     for d in data {
...
// pub fn sha256_joined_prefix(data: &[&[u8]], prefix: usize) -> Vec<u8> {
//     let digest = sha256_joined(data);
//     digest.iter().take(prefix).copied().collect()
// }
...
mod tests {
    ...
    fn test_sha256() {
        ...
        assert_eq!(sha256(data), hex!("a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e"));
    }

    // #[test]
    // fn test_sha256_joined() {
    //     let data1 = "Hello ".as_bytes();
    //     let data2 = "World".as_bytes();
    //     assert_eq!(sha256_joined(&[data1, data2]), hex!("a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e"));
    // }

    // #[test]
    // fn test_sha256_joined_prefix() {
    //     let data1 = "Hello ".as_bytes();
    //     let data2 = "World".as_bytes();
    //     assert_eq!(sha256_joined_prefix(&[data1, data2], 4), hex!("a591a6d4"));
    // }

    #[test]
    fn test_extend_key() {
        let data = b"Hello World";
        assert_eq!(extend_key(data), hex!("813085a508d5fec645abe5a1fb9a23c2a6ac6bef0a99650017b3ef50538dba39"));
    }
